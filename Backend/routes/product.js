...
import { addProduct, addToCard, deleteProduct, index, removeFromCard, showProduct, updateProduct } from "../controller/product.js";
...
router.delete("/removeFromCard/:id",authJwt,removeFromCard)
